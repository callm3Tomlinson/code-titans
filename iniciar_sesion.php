...
<html lang="en">
  ...
  <body>
    ...
    <div class="wrapper container d-flex flex-column justify-content-evenly align-items-center mx-auto text-center bg-info">
      ...
      <form action="vistas\admin.php" class="col-lg-3">
        ...
        <div class="col-auto">
          <button type="submit" class="btn btn-primary mb-3 w-100 border-0">Iniciar Sesión</button>
        </div>     
